...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  [`&.${tableCellClasses.head}`]: {
    backgroundColor: '#0000FF', // Red color for header background
    color: '#fff', // White text for header
  },
  [`&.${tableCellClasses.body}`]: {
    fontSize: 14,
    color: '#000', // Black color for body text
    backgroundColor: '#fffff', // Red color for header background
  },
}));  
...
const rows = [
  createData('Frozen yoghurt', "https://mui.com/material-ui/customization/color/", .0, 24, 4.0),
