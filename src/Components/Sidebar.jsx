...
import { HiOutlineChevronRight, HiOutlineChevronLeft } from 'react-icons/hi'; // Import new icons
      ...
      <div className='Big_css'>
        <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
          <div className="Logo" onClick={handleToggle}>
            <img src={logo} alt="Logo" className="logo_image" onClick={handleToggle} />
          ...
          {!isCollapsed && (
            <ul>
              <li><HiOutlineUsers className="users" /><a className='user' href="#">Сотрудники</a></li>
              <li><HiOutlineBars3 className="line" /><a href="#">Проекты</a></li>
            </ul>
          )}
        </div>
      </div>
